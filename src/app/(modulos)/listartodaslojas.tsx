      ...
      <ul className="m-0-auto font-inter w-auto text-xs">
        ...
        <li className="relative float-left m-0">
          ...
          >
            <Image
              alt="Teste"
              src="https://achetudotiradentes-nextjs-app.s3.sa-east-1.amazonaws.com/empresas/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a_1.jpg"
              width={0}
              height={0}
              sizes="100vw"
              priority={false}
          ...
          >
            <div className="relative m-auto box-border block h-80 w-screen rounded-2xl pt-0 shadow-xl/30 md:left-[-150px] md:h-90 md:w-110">
              <figure className="absolute box-border h-[100%] w-[100%] rounded-b-2xl bg-[url('https://achetudotiradentes-nextjs-app.s3.sa-east-1.amazonaws.com/empresas/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a_1.jpg')] bg-size-[100%_100%] bg-center bg-no-repeat"></figure>
              <figure className="animate-slider absolute box-border h-[100%] w-[100%] rounded-b-2xl bg-[url('https://achetudotiradentes-nextjs-app.s3.sa-east-1.amazonaws.com/empresas/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a_2.jpg')] bg-size-[100%_100%] bg-center bg-no-repeat opacity-0 transition-opacity delay-4000"></figure>
              <figure className="animate-slider absolute box-border h-[100%] w-[100%] rounded-b-2xl bg-[url('https://achetudotiradentes-nextjs-app.s3.sa-east-1.amazonaws.com/empresas/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a/97d390b9-fcd7-4968-8cc3-7fbae83f1b2a_3.jpg')] bg-size-[100%_100%] bg-center bg-no-repeat opacity-0 transition-opacity delay-10000"></figure>
            </div>
            <section className="font-comfortaa absolute top-58 left-1 box-border h-auto w-85 rounded-2xl bg-white p-3 md:top-10 md:left-135">
              <div className="float-start h-auto w-full pt-1 pb-1">
                <div className="pb-3 text-center">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d914.1077500086368!2d-46.400282827786285!3d-23.588870899999975!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce6f5ec7301343%3A0x2c41844e94a8d599!2sBelly%20Perfumaria%20Setor%20G!5e0!3m2!1spt-BR!2sbr!4v1767887597831!5m2!1spt-BR!2sbr"
                    width="315"
                    height="210"
                    style={{ border: 0 }}
                    loading="lazy"
