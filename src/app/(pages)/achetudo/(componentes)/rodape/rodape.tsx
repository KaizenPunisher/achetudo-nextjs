...
export default function Rodape() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`${animateRodape} absolute m-0 w-screen justify-center bg-yellow-300 bg-[url('https://achetudotiradentes-nextjs-app.s3.sa-east-1.amazonaws.com/pages/4570f0bd-125f-4319-846e-9e263ffa66ee/fundo_footer_1.png')] bg-size-[50%_30%] bg-left-bottom bg-no-repeat pt-0 pb-20 lg:bg-size-[17%_40%] lg:bg-[30rem_24rem] 2xl:bg-size-[15%_40%] 2xl:bg-[40rem_35rem]`}
        >
            ...
            >
              ...
              <div className="w-auto p-4">
                <p className="text-amber-800">
                  <strong className="text-blue-950">R$500,00</strong> --
                  Estrutura Fixa e sem modificações dentro da hospedagem e
              ...
              <div className="p-4">
                ...
                <p className="text-amber-800">
                  <strong className="text-blue-950">R$300,00</strong> --
              ...
              <div className="p-4">
                ...
                <p className="text-amber-800">
                  <strong className="text-blue-950">R$1200,00</strong> --
                  Suporte anual para alteração no site
                </p>
              </div>
          ...
          <div className="relative top-[-11vh] h-auto bg-amber-500 p-6 text-center 2xl:top-[-10vh]">
            <p>© 2023 Dio Santos.</p>
