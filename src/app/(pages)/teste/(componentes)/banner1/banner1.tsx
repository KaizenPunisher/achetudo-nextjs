...
export default function Banner1() {
  useEffect(() => {
    const rolagem = () => {
      ...
      if (value > 200) {
        banner_1.style.top = `${(value - 205) * -3}px`;
      }
    };
  ...
  return (
    <div
      className="fixed top-0 left-0 z-10 h-auto w-[65vw] border-4 border-black pt-[60vh] transition-all duration-100 lg:h-auto lg:w-[52.7vw]"
      id="banner_1"
    >
      <div className="z-20 float-right h-50 w-29 bg-[url('https://achetudotiradentes-nextjs-app.s3.sa-east-1.amazonaws.com/pages/4570f0bd-125f-4319-846e-9e263ffa66ee/celular.png')] bg-size-[100%_100%] bg-position-[0rem_0rem] bg-no-repeat pt-[1.1rem] pl-[0.7rem]">
