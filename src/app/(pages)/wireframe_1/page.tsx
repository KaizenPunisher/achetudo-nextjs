...
export default function WireFrame_1() {
  useEffect(() => {
    const rolagem = () => {
      ...
      if (slider) slider.style.height = `${value * -1}px`;
      console.log(value);
    };
  ...
  return (
    <>
      <main className="relative top-0 left-0 m-auto flex h-full w-screen flex-col items-center justify-center bg-white">
        ...
        <div className="absolute top-0 left-0 z-10 h-60 w-50 border-4 border-black pt-20">
          <figure className="h-30 w-30 bg-blue-500"></figure>
        </div>
